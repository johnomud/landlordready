...
module.exports = async function(req, res) {
  ...
  if (sessionAge > 48 * 3600) {
    return res.status(410).json({ 
      error: 'Download link expired. Please email help@landlordready.co.uk for a fresh link.',
      expired: true
    });
  }
  ...
  res.setHeader('Content-Disposition', 'attachment; filename="LandlordReady-Document-Pack.zip"');
